...
import 'package:flutter_demo_jsonplaceholder_v1/providers/state_noti_provider/post_list_view_model_provider.dart';
import 'package:flutter_demo_jsonplaceholder_v1/view/post/post_create_page.dart';
import 'package:flutter_demo_jsonplaceholder_v1/view/post/post_detail_page.dart';
...
class PostListPage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      body: posts.isEmpty
          ? const Center(
              child: Text('No Posts Available')) // 포스트가 없을 경우 메시지를 표시합니다.
          : ListView.separated(
